...
namespace AvansDevOps.Domain
{
    internal class ReleaseSprint : Sprint
    {
        ...
        public ReleaseSprint(string name, DateTime startDate, DateTime endDate, ScrumMaster scrumMaster, LinkedList<Developer> developers, LinkedList<Tester> testers, LinkedList<BacklogItem> backlog) : base(name, startDate, endDate, scrumMaster, developers, testers, backlog/*, sprintState*/)
        {
